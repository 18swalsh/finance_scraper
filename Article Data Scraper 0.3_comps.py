...
for ticker in tickers:
    ...
    worksheet.write('E68', '=IF(AND(C68<>"",D68<>0),IF(J68>K68,"above average","below average"),"no data")')
    worksheet.write('E69', '=IF(AND(C69<>"",D69<>0),IF(J69>K69,"above average","below average"),"no data")')
    worksheet.write('E70', '=IF(AND(C70<>"",D70<>0),IF(J70>K70,"above average","below average"),"no data")')
    worksheet.write('E71', '=IF(AND(C71<>"",D71<>0),IF(J71>K71,"above average","below average"),"no data")')
    worksheet.write('E72', '=IF(AND(C72<>"",D72<>0),IF(J72>K72,"above average","below average"),"no data")')
    worksheet.write('E73', '=IF(AND(C73<>"",D73<>0),IF(J73>K73,"above average","below average"),"no data")')
    worksheet.write('E74', '=IF(AND(C74<>"",D74<>0),IF(J74>K74,"above average","below average"),"no data")')
    worksheet.write('E75', '=IF(AND(C75<>"",D75<>0),IF(J75>K75,"above average","below average"),"no data")')
    worksheet.write('E76', '=IF(AND(C76<>"",D76<>0),IF(J76>K76,"above average","below average"),"no data")')
    ...
    worksheet.write('G77', '=SUBSTITUTE(G76,F77, "and " & F77)')

    worksheet.write('D78', '=IF(COUNTIF(E70:E76,"=above average")>1,"There are some indications that "&D1&" may be overvalued. The company has a higher " & G77 & " than the comparable average", "Inconclusive")')
    #additons
